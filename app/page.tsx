      ...
      <main>
        <div className="mx-auto max-w-7xl  px-4 sm:px-6 lg:px-8 pb-16 pt-20 text-center lg:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
            Most finance apps pack in features at the expense of ease. We
            prioritize simplicity, aiming for seamless financial management
          ...
          <div className="mt-36 lg:mt-44">
            ...
            <ul className="flex items-center justify-center mt-5 gap-10">
              <li>
                <div className="text-2xl">
                <span className="animate-pulse px-0.5 py-1 bg-gradient-to-r from-gray-900 via-gray-600 to-gray-300 rounded-lg bg-clip-text text-transparent">
  Code
</span>
              ...
              <li>
                <Image
                  src="/cortes-corp-logo.svg"
                  width={140}
                  height={110}
                  alt="cortes-logo"></Image>
              </li>
            </ul>
          </div>
        </div>
